...
function Footer() {
  const location = useLocation()
    return ( 
        <div className={`p-2 container ${location.pathname === "/" ? "hidden md:flex fixed bottom-0 left-1/2 -translate-x-1/2 z-10" : "flex"} mx-auto`}>
           ...
           <div className="w-1/2 pe-3 flex items-center justify-end">
             <ul className="flex gap-3">
                 <li className="flex justify-center items-center w-8 h- rounded-full hover:rotate-360 transition duration-500">
                  ...
                  <li className="flex justify-center items-center w-8 h-8 rounded-full hover:rotate-360 transition duration-500">
